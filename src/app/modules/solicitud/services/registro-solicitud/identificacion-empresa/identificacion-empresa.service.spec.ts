...
import { IdentificacionEmpresaService } from './identificacion-empresa.service';

fdescribe('IdentificacionEmpresaService', (): void => {
  let service: IdentificacionEmpresaService;
  let httpMock: HttpTestingController;

  const URL: string = 'http://3aa8b8e5a00c.ngrok.io:80/api-vuce/v1/anexos';
  ...
  beforeEach((): void => {
    ...
    service = TestBed.inject(IdentificacionEmpresaService);
